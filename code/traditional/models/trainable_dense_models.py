...
class BiEncoder(nn.Module):
    def __init__(self, 
                 ...
                 score_fn: str = 'dot', #scoring function between passage embeddings (default is set to dot product; can also be set to cosine similarity).
...
class WordEncoder(nn.Module):
    def __init__(self, model_name_or_path: str, truncation: bool, max_input_len: Optional[int], chunk_size: Optional[int], window_size: int): 
        ...
        self.config = self._get_config_dict(locals())
        self.tokenizer = AutoTokenizer.from_pretrained(model_name_or_path, cache_dir="/tmp2/b10705005/cache/hf")
        self.encoder = AutoModel.from_pretrained(model_name_or_path, cache_dir="/tmp2/b10705005/cache/hf")
